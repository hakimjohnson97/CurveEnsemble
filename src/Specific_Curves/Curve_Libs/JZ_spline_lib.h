...
if (u2 > alpha_max || u2>M_PI_2+tol || v2 > alpha_max || v2>M_PI_2+tol )
  return false;
else
  return true;
}// is_feasible_lite----------------------------------------------------------------------------------------
...
if (FORM8[3]==3)
  ...
  q.form = (short) 1; q.p1 = p18*p18; q.p2 = p18*p28; q.q1=q18*q18; q.q2=q18*q28; q.alpha=alpha; q.beta=beta;
} // else
