...
#ifndef CUBICQUASIELASTICSPLINE_H
#define CUBICQUASIELASTICSPLINE_H
...
namespace CubicQuasiElasticS {

struct piece;

}

class CubicQuasiElasticSpline : public Curve
{
  public:
      CubicQuasiElasticSpline();
...
#endif // CUBICQUASIELASTICSPLINE_H
