...
#include "Curve_Libs/cond_G2_cubic_lib.h"
using namespace std;
using namespace CondG2CubicS;
...
int CondG2Cubic::getForm(int index)
{
   // return pieces[index].form;
}


void CondG2Cubic::S_splineFeasible()
{
...
void CondG2Cubic::S_splineFeasibleSmart()
{
    S_spline_feasible_stencil(H, count, coarseRes);
}

void CondG2Cubic::S_splineFeasibleSmart3(int index)
{
    S_spline_feasible_stencil3(H, count, coarseRes, index);
}

void CondG2Cubic::optimizeCurve(double** nodes, int numNodes, InitDir initDir)
{
    int i;
    double theta[coarseRes];
    equi_angular_partition(theta, coarseRes);
...
void CondG2Cubic::fineOptimizeCurve(double **nodes, int numNodes, int depth)
{
     int i;
...
/*int CondG2Cubic::save(fstream &file)
{

}

int CondG2Cubic::load(fstream &file)
{

}

int CondG2Cubic::saveAsText(fstream &file)
{

}

int CondG2Cubic::loadFromText(fstream &file)
{

} */

int CondG2Cubic::S_Curve(double *a, double *b, double *rx, double *ry)
{
...
Curve::Node CondG2Cubic::pointInTheMiddle(double *a, double *b)
{
    piece p;
    if (make_piece(a, b, &p) == 0)    {
...
void CondG2Cubic::boundingRect(double &x, double &y, double &width, double &height)
{
